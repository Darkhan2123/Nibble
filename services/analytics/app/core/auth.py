...
async def get_current_restaurant(current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
...
async def get_current_driver(current_user: Dict[str, Any] = Depends(get_current_user)) -> Dict[str, Any]:
